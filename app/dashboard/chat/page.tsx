    ...
    <>
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4">
          {/* Subject selector */}
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#1f1f1f] dark:bg-black">
            ...
            <select
              ...
              className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-indigo-400 dark:border-[#1f1f1f] dark:bg-black dark:text-white"
            >
              {subjects.map((s) => (
        ...
        <div className="space-y-4">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#1f1f1f] dark:bg-black md:p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-[#a1a1a1]">
